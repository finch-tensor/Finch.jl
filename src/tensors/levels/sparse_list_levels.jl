...
function transfer(lvl::SparseListLevel{Ti,Ptr,Idx,Lvl}, Tm) where {Ti,Ptr,Idx,Lvl}
...
function virtual_transfer_level(ctx::AbstractCompiler, lvl::VirtualSparseListLevel, arch)
