...
f = :(function run(tens)
      @inbounds @fastmath(begin
                  ...
                  Threads.@threads :dynamic for tid = 1:n_2
                          Finch.@barrier begin
                                  @inbounds @fastmath(begin
                                              tens_lvl_2_qos_fill_3 = true_fill[tid]
                                              ...
                                              println(@which (Finch).transfer(Finch.MemoryChannel(tid, Finch.MultiChannelMemory(Finch.CPU{1}(n_2), n_2), Finch.CPUThread(tid, Finch.CPU{1}(n_2), Finch.SerialTask())), tens_lvl_3_tbl_2))
                                                              ...
                                                              for i_4 = 1:tens_lvl_3_stop
                                                                  ...
                                                                  if tens_lvl_3_qos == 0
                                                                      if !(isempty(tens_lvl_3_pool))
                                                                          ...
                                                                          while tens_lvl_3_qos > tens_lvl_3_qos_stop
