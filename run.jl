...
code = :(function run(tens)
      @inbounds @fastmath(begin
                  tens_lvl = tens.lvl
                  tens_lvl_coalref = tens_lvl.coalescent
                  n = tens_lvl.device.n
                  tens_lvl_2 = tens_lvl.lvl
                  tens_lvl_2_stop = tens_lvl_2.shape
                  ...
                  tens_lvl_6_stop = tens_lvl_6.shape
                  ...
                  Threads.@threads :dynamic for tid = 1:n
                          Finch.@barrier begin
                                  @inbounds @fastmath(begin
                                              ...
                                              resize!(tens_lvl_3_ptr_3, tens_lvl_2_stop + 1)
                                              for p = 1:tens_lvl_2_stop
                                                  tens_lvl_3_ptr_3[p + 1] += tens_lvl_3_ptr_3[p]
                                              end
                                              qos_stop = tens_lvl_3_ptr_3[tens_lvl_2_stop + 1] - 1
                                              resize!(tens_lvl_3_idx_3, qos_stop)
                                              resize!(tens_lvl_4_val_3, qos_stop)
                                              Finch.VirtualDenseLevel(:tens_lvl_2, Finch.VirtualSparseListLevel(:tens_lvl_3, Finch.VirtualElementLevel(:tens_lvl_4, 0.0, Float64, Int64, :tens_lvl_4_val_3), Int64, :tens_lvl_3_ptr_3, :tens_lvl_3_idx_3, value(tens_lvl_3_stop, Int64), :tens_lvl_3_qos_fill, :tens_lvl_3_qos_stop, :tens_lvl_3_prev_pos), Int64, value(tens_lvl_2_stop, Int64))
                                          end)
                                  nothing
                              end
                      end
                  ...
                  Threads.@threads :dynamic for tid_2 = 1:n
                          Finch.@barrier begin
                                  @inbounds @fastmath(begin
                                              ...
                                              Finch.resize_if_smaller!(tens_lvl_3_ptr_5, tens_lvl_2_stop + 1)
                                              Finch.fill_range!(tens_lvl_3_ptr_5, 0, 1 + 1, tens_lvl_2_stop + 1)
                                              resize!(tens_lvl_3_ptr_5, tens_lvl_2_stop + 1)
                                              for p_4 = 1:tens_lvl_2_stop
                                                  tens_lvl_3_ptr_5[p_4 + 1] += tens_lvl_3_ptr_5[p_4]
                                              end
                                              qos_stop_4 = tens_lvl_3_ptr_5[tens_lvl_2_stop + 1] - 1
                                              resize!(tens_lvl_3_idx_5, qos_stop_4)
                                              resize!(tens_lvl_4_val_5, qos_stop_4)
                                              Finch.VirtualDenseLevel(:tens_lvl_2, Finch.VirtualSparseListLevel(:tens_lvl_3, Finch.VirtualElementLevel(:tens_lvl_4, 0.0, Float64, Int64, :tens_lvl_4_val_5), Int64, :tens_lvl_3_ptr_5, :tens_lvl_3_idx_5, value(tens_lvl_3_stop, Int64), :tens_lvl_3_qos_fill, :tens_lvl_3_qos_stop, :tens_lvl_3_prev_pos), Int64, value(tens_lvl_2_stop, Int64))
                                          end)
                                  nothing
                              end
                      end
                  for p_5 = 0:-1:1
                      tens_lvl_6_ptr[p_5 + 1] = tens_lvl_6_ptr[p_5 + 1] - tens_lvl_6_ptr[p_5]
                  end
                  Finch.resize_if_smaller!(tens_lvl_6_ptr, tens_lvl_5_stop + 1)
                  Finch.fill_range!(tens_lvl_6_ptr, 0, 1 + 1, tens_lvl_5_stop + 1)
                  resize!(tens_lvl_6_ptr, tens_lvl_5_stop + 1)
                  for p_6 = 1:tens_lvl_5_stop
                      tens_lvl_6_ptr[p_6 + 1] += tens_lvl_6_ptr[p_6]
                  end
                  qos_stop_6 = tens_lvl_6_ptr[tens_lvl_5_stop + 1] - 1
                  resize!(tens_lvl_6_idx, qos_stop_6)
                  resize!(tens_lvl_7_val, qos_stop_6)
                  ...
                  gfm = ones(Int, n)
                  lfm = ones(Int, n)
                  coalesce_level!((CoalesceLevel)(Finch.CPU{:t}(n), (DenseLevel){Int64}((SparseListLevel){Int64}(ElementLevel{0.0, Float64, Int64}(tens_lvl_4_val), tens_lvl_3_stop, tens_lvl_3_ptr, tens_lvl_3_idx), tens_lvl_2_stop), tens_lvl_coalref, tens_lvl.schedule), gfm, lfm, tm, 1, n, (DenseLevel){Int64}((SparseListLevel){Int64}(ElementLevel{0.0, Float64, Int64}(tens_lvl_7_val), tens_lvl_6_stop, tens_lvl_6_ptr, tens_lvl_6_idx), tens_lvl_5_stop))
                  result
              end)
  end)
