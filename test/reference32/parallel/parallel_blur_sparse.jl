begin
    ...
    tmp_lvl_2_val_2 = (Finch).transfer(Finch.CPULocalMemory(Finch.CPU{test}(n)), tmp_lvl_2_val)
    ...
    Threads.@threads :dynamic for tid = 1:n
            Finch.@barrier begin
                    @inbounds @fastmath(begin
                                tmp_lvl_2_val_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU{test}(n), Finch.Serial()), tmp_lvl_2_val_2)
                                input_lvl_3_val_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU{test}(n), Finch.Serial()), input_lvl_3_val_2)
                                input_lvl_2_ptr_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU{test}(n), Finch.Serial()), input_lvl_2_ptr_2)
                                input_lvl_2_idx_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU{test}(n), Finch.Serial()), input_lvl_2_idx_2)
                                output_lvl_3_val_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU{test}(n), Finch.Serial()), output_lvl_3_val_2)
