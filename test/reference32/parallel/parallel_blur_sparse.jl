begin
    ...
    input_lvl_2_stop == 1 + input_lvl_2_stop || throw(
        DimensionMismatch(
            "mismatched dimension limits ($(input_lvl_2_stop) != $(1 + input_lvl_2_stop))"
        ),
    )
    input_lvl_stop == input_lvl_stop || throw(
        DimensionMismatch(
            "mismatched dimension limits ($(input_lvl_stop) != $(input_lvl_stop))"
        ),
    )
    1 == 1 || throw(DimensionMismatch("mismatched dimension limits ($(1) != $(1))"))
    1 == 0 || throw(DimensionMismatch("mismatched dimension limits ($(1) != $(0))"))
    input_lvl_2_stop == input_lvl_2_stop + -1 || throw(
        DimensionMismatch(
            "mismatched dimension limits ($(input_lvl_2_stop) != $(input_lvl_2_stop + -1))"
        ),
    )
    1 == 1 || throw(DimensionMismatch("mismatched dimension limits ($(1) != $(1))"))
    ...
    input_lvl_3_val_2 = (Finch).transfer(
        (Finch.CPUSharedMemory)(Finch.CPU{:test}(n)), input_lvl_3_val
    )
    input_lvl_2_ptr_2 = (Finch).transfer(
        (Finch.CPUSharedMemory)(Finch.CPU{:test}(n)), input_lvl_2_ptr
    )
    input_lvl_2_idx_2 = (Finch).transfer(
        (Finch.CPUSharedMemory)(Finch.CPU{:test}(n)), input_lvl_2_idx
    )
    output_lvl_3_val_2 = (Finch).transfer(
        (Finch.CPUSharedMemory)(Finch.CPU{:test}(n)), output_lvl_3_val
    )
    Threads.@threads :dynamic for tid in 1:n
        Finch.@barrier begin
            @inbounds @fastmath(
                begin
                    tmp_lvl_2_val_3 = (Finch).transfer(
                        (Finch.CPUThread)(tid, Finch.CPU{:test}(n), (Finch.SerialTask)()),
                        tmp_lvl_2_val_2,
                    )
                    input_lvl_3_val_3 = (Finch).transfer(
                        (Finch.CPUThread)(tid, Finch.CPU{:test}(n), (Finch.SerialTask)()),
                        input_lvl_3_val_2,
                    )
                    input_lvl_2_ptr_3 = (Finch).transfer(
                        (Finch.CPUThread)(tid, Finch.CPU{:test}(n), (Finch.SerialTask)()),
                        input_lvl_2_ptr_2,
                    )
                    input_lvl_2_idx_3 = (Finch).transfer(
                        (Finch.CPUThread)(tid, Finch.CPU{:test}(n), (Finch.SerialTask)()),
                        input_lvl_2_idx_2,
                    )
                    output_lvl_3_val_3 = (Finch).transfer(
                        (Finch.CPUThread)(tid, Finch.CPU{:test}(n), (Finch.SerialTask)()),
                        output_lvl_3_val_2,
                    )
                    ...
                    if phase_stop_2 >= phase_start_2
                        for y_8 in phase_start_2:phase_stop_2
                            ...
                            if phase_stop_3 >= 1
                                ...
                                if input_lvl_2_idx_3[input_lvl_2_q] < -1 + 1
                                    input_lvl_2_q = Finch.scansearch(
                                        input_lvl_2_idx_3,
                                        -1 + 1,
                                        input_lvl_2_q,
                                        input_lvl_2_q_stop - 1,
                                    )
                                end
                                if input_lvl_2_idx_3[input_lvl_2_q_2] < 1
                                    input_lvl_2_q_2 = Finch.scansearch(
                                        input_lvl_2_idx_3,
                                        1,
                                        input_lvl_2_q_2,
                                        input_lvl_2_q_stop_2 - 1,
                                    )
                                end
                                if input_lvl_2_idx_3[input_lvl_2_q_3] < 1 + 1
                                    input_lvl_2_q_3 = Finch.scansearch(
                                        input_lvl_2_idx_3,
                                        1 + 1,
                                        input_lvl_2_q_3,
                                        input_lvl_2_q_stop_3 - 1,
                                    )
                                end
                                while x <= phase_stop_3
                                    ...
                                    if (
                                        input_lvl_2_i == -1 + phase_stop_4 &&
                                        input_lvl_2_i_2 == phase_stop_4
                                    ) && input_lvl_2_i_3 == 1 + phase_stop_4
                                        ...
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + phase_stop_4
                                        tmp_lvl_2_val_3[tmp_lvl_q] =
                                            input_lvl_3_val_4 + input_lvl_3_val_5 +
                                            input_lvl_3_val_6 + tmp_lvl_2_val_3[tmp_lvl_q]
                                        input_lvl_2_q += 1
                                        input_lvl_2_q_2 += 1
                                        input_lvl_2_q_3 += 1
                            ...
                            phase_stop_5 = min(
                                input_lvl_2_stop, input_lvl_2_i1_2, -1 + input_lvl_2_i1_3
                            )
                            if phase_stop_5 >= phase_start_5
                                ...
                                while x <= phase_stop_5
                                    ...
                                    input_lvl_2_i_3 = input_lvl_2_idx_3[input_lvl_2_q_3]
                                    phase_stop_6 = min(
                                        input_lvl_2_i_2, -1 + input_lvl_2_i_3, phase_stop_5
                                    )
                                    if input_lvl_2_i_2 == phase_stop_6 &&
                                        input_lvl_2_i_3 == 1 + phase_stop_6
                                        input_lvl_3_val_8 = input_lvl_3_val_3[input_lvl_2_q_3]
                                        input_lvl_3_val_7 = input_lvl_3_val_3[input_lvl_2_q_2]
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + phase_stop_6
                                        tmp_lvl_2_val_3[tmp_lvl_q] =
                            ...
                            phase_stop_7 = min(
                                input_lvl_2_stop, -1 + input_lvl_2_i1_3, 1 + input_lvl_2_i1
                            )
                            ...
                            if phase_stop_9 >= phase_start_9
                                ...
                                while true
                                    ...
                                    if phase_stop_10 < phase_stop_9
                                        ...
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + phase_stop_10
                                        tmp_lvl_2_val_3[tmp_lvl_q] += input_lvl_3_val_11
                                        input_lvl_2_q_3 += 1
                                    else
                                        phase_stop_11 = min(
                                            -1 + input_lvl_2_i_3, phase_stop_9
                                        )
                                        if input_lvl_2_i_3 == 1 + phase_stop_11
                                            input_lvl_3_val_11 = input_lvl_3_val_3[input_lvl_2_q_3]
                                            tmp_lvl_q =
                                                (1 - 1) * input_lvl_2_stop + phase_stop_11
                                            tmp_lvl_2_val_3[tmp_lvl_q] +=
                                                input_lvl_3_val_11
                                            input_lvl_2_q_3 += 1
                                        end
                            ...
                            phase_stop_12 = min(
                                input_lvl_2_stop, input_lvl_2_i1_2, 1 + input_lvl_2_i1
                            )
                            if phase_stop_12 >= phase_start_12
                                ...
                                while x <= phase_stop_12
                                    ...
                                    input_lvl_2_i = input_lvl_2_idx_3[input_lvl_2_q]
                                    phase_stop_13 = min(
                                        input_lvl_2_i_2, 1 + input_lvl_2_i, phase_stop_12
                                    )
                                    if input_lvl_2_i_2 == phase_stop_13 &&
                                        input_lvl_2_i == -1 + phase_stop_13
                                        input_lvl_3_val_12 = input_lvl_3_val_3[input_lvl_2_q]
                                        input_lvl_3_val_13 = input_lvl_3_val_3[input_lvl_2_q_2]
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + phase_stop_13
                                        tmp_lvl_2_val_3[tmp_lvl_q] =
                                            tmp_lvl_2_val_3[tmp_lvl_q] +
                                            input_lvl_3_val_13 + input_lvl_3_val_12
                                        input_lvl_2_q_2 += 1
                                        input_lvl_2_q += 1
                            ...
                            if phase_stop_14 >= phase_start_14
                                ...
                                while true
                                    ...
                                    if input_lvl_2_i_2 < phase_stop_14
                                        ...
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + input_lvl_2_i_2
                                        ...
                                        if input_lvl_2_i_2 == phase_stop_16
                                            input_lvl_3_val_14 = input_lvl_3_val_3[input_lvl_2_q_2]
                                            tmp_lvl_q =
                                                (1 - 1) * input_lvl_2_stop + phase_stop_16
                                            tmp_lvl_2_val_3[tmp_lvl_q] +=
                                                input_lvl_3_val_14
                                            input_lvl_2_q_2 += 1
                                        end
                            ...
                            if phase_stop_17 >= phase_start_16
                                ...
                                while true
                                    ...
                                    if phase_stop_18 < phase_stop_17
                                        ...
                                        tmp_lvl_q =
                                            (1 - 1) * input_lvl_2_stop + phase_stop_18
                                        tmp_lvl_2_val_3[tmp_lvl_q] += input_lvl_3_val_15
                                        input_lvl_2_q += 1
                                    else
                                        phase_stop_19 = min(
                                            1 + input_lvl_2_i, phase_stop_17
                                        )
                                        if input_lvl_2_i == -1 + phase_stop_19
                                            input_lvl_3_val_15 = input_lvl_3_val_3[input_lvl_2_q]
                                            tmp_lvl_q =
                                                (1 - 1) * input_lvl_2_stop + phase_stop_19
                                            tmp_lvl_2_val_3[tmp_lvl_q] +=
                                                input_lvl_3_val_15
                                            input_lvl_2_q += 1
                                        end
                            ...
                            for x_46 in 1:input_lvl_2_stop
                                output_lvl_2_q =
                                    (output_lvl_q - 1) * input_lvl_2_stop + x_46
    ...
    (
        output=Tensor(
            (DenseLevel){Int32}(
                (DenseLevel){Int32}(
                    ElementLevel{0.0,Float64,Int32}(output_lvl_3_val_2), input_lvl_2_stop
                ),
                input_lvl_stop,
            ),
        ),
