                ...
                begin
                    ...
                    if phase_stop_2 >= phase_start_2
                        for y_8 in phase_start_2:phase_stop_2
                            ...
                            for x_9 in 1:input_lvl_2_stop
                                tmp_lvl_q = (1 - 1) * input_lvl_2_stop + x_9
                                input_lvl_2_q =
                                    (input_lvl_q_2 - 1) * input_lvl_2_stop + (-1 + x_9)
                                input_lvl_2_q_2 =
                                    (input_lvl_q - 1) * input_lvl_2_stop + x_9
                                input_lvl_2_q_3 =
                                    (input_lvl_q_3 - 1) * input_lvl_2_stop + (1 + x_9)
                                ...
                                tmp_lvl_2_val_3[tmp_lvl_q] =
                                    input_lvl_3_val_5 + input_lvl_3_val_4 +
                                    input_lvl_3_val_6 + tmp_lvl_2_val_3[tmp_lvl_q]
                            end
                            resize!(tmp_lvl_2_val_3, input_lvl_2_stop)
                            for x_10 in 1:input_lvl_2_stop
                                output_lvl_2_q =
                                    (output_lvl_q - 1) * input_lvl_2_stop + x_10
