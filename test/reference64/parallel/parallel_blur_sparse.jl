begin
    ...
    tmp_lvl_2_val_2 = (Finch).transfer((CPULocalMemory)((CPU){test}(n)), tmp_lvl_2_val)
    input_lvl_3_val_2 = (Finch).transfer((Finch.CPUSharedMemory)((CPU){test}(n)), input_lvl_3_val)
    input_lvl_2_ptr_2 = (Finch).transfer((Finch.CPUSharedMemory)((CPU){test}(n)), input_lvl_2_ptr)
    input_lvl_2_idx_2 = (Finch).transfer((Finch.CPUSharedMemory)((CPU){test}(n)), input_lvl_2_idx)
    output_lvl_3_val_2 = (Finch).transfer((Finch.CPUSharedMemory)((CPU){test}(n)), output_lvl_3_val)
    Threads.@threads :dynamic for tid = 1:n
            Finch.@barrier begin
                    @inbounds @fastmath(begin
                                tmp_lvl_2_val_3 = (Finch).transfer((Finch.CPUThread)(tid, (CPU){test}(n), (Finch.SerialTask)()), tmp_lvl_2_val_2)
                                input_lvl_3_val_3 = (Finch).transfer((Finch.CPUThread)(tid, (CPU){test}(n), (Finch.SerialTask)()), input_lvl_3_val_2)
                                input_lvl_2_ptr_3 = (Finch).transfer((Finch.CPUThread)(tid, (CPU){test}(n), (Finch.SerialTask)()), input_lvl_2_ptr_2)
                                input_lvl_2_idx_3 = (Finch).transfer((Finch.CPUThread)(tid, (CPU){test}(n), (Finch.SerialTask)()), input_lvl_2_idx_2)
                                output_lvl_3_val_3 = (Finch).transfer((Finch.CPUThread)(tid, (CPU){test}(n), (Finch.SerialTask)()), output_lvl_3_val_2)
