...
<<<<<<< HEAD
                                ...
                                input_lvl_2_ptr_3 = (Finch).transfer(CPUThread(tid, cpu, SerialTask()), input_lvl_2_ptr_2)
                                input_lvl_2_idx_3 = (Finch).transfer(CPUThread(tid, cpu, SerialTask()), input_lvl_2_idx_2)
