begin
    ...
    A_lvl_2_stop == A_lvl_stop || throw(
        DimensionMismatch("mismatched dimension limits ($(A_lvl_2_stop) != $(A_lvl_stop))")
    )
    B_lvl_2_qos_fill = 0
    B_lvl_2_qos_stop = 0
    B_lvl_2_prev_pos = 0
    ...
    for j_4 in 1:A_lvl_stop
        ...
        for w_lvl_r in 1:w_lvl_qos_fill
                    ...
                    if phase_stop_3 >= 1
                        ...
                        while true
                            ...
                            if A_lvl_2_i_2 < phase_stop_3
                                ...
                                w_lvl_2_val[w_lvl_q_2] =
                                    A_lvl_3_val_2 * A_lvl_3_val_3 + w_lvl_2_val[w_lvl_q_2]
                    ...
                    if A_lvl_2_i == phase_stop_7
                        ...
                        if phase_stop_8 >= 1
                            if A_lvl_2_idx[A_lvl_2_q_3] < 1
                                A_lvl_2_q_3 = Finch.scansearch(
                                    A_lvl_2_idx, 1, A_lvl_2_q_3, A_lvl_2_q_stop_3 - 1
                                )
                            end
                            while true
                                ...
                                if A_lvl_2_i_3 < phase_stop_8
                                    ...
                                    w_lvl_2_val[w_lvl_q_3] =
                                        A_lvl_3_val_2 * A_lvl_3_val_4 +
                                        w_lvl_2_val[w_lvl_q_3]
        ...
        sort!(w_lvl_srt)
        w_lvl_p_prev = 0
        for w_lvl_r_2 in 1:w_lvl_qos_fill
                ...
                if w_lvl_i_2 < phase_stop_13
                    ...
                    if w_lvl_i_2 == phase_stop_15
                        ...
                        if B_lvl_2_qos > B_lvl_2_qos_stop
                            ...
                            Finch.resize_if_smaller!(B_lvl_3_val, B_lvl_2_qos_stop)
                            Finch.fill_range!(
                                B_lvl_3_val, 0.0, B_lvl_2_qos, B_lvl_2_qos_stop
                            )
                        end
        ...
        B=Tensor(
            (DenseLevel){Int64}(
                (SparseListLevel){Int64}(
                    ElementLevel{0.0,Float64,Int64}(B_lvl_3_val),
                    A_lvl_2_stop,
                    B_lvl_2_ptr,
                    B_lvl_2_idx,
                ),
